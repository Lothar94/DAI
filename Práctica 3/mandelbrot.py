...
def renderizaMandelbrotBonito(x1, y1, x2, y2, ancho, iteraciones, nombreFicheroPNG, nombreFicheroPNGDisco, paleta, nColoresPaleta):
	# drawing area
	xa = x1
	xb = x2
	ya = y1 + 0.000001
	...
	image.save(nombreFicheroPNGDisco, "PNG")
	image.save(nombreFicheroPNG, "PNG")
