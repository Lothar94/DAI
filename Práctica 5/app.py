...
def restaurants():
    AddLink("/restaurants")
    historial = session["last_visited"]
    if "username" in session:
        username = session["username"]
        return render_template("restaurants.html", username = username, historial = historial)
    else:
        return render_template("restaurants.html", historial = historial)
